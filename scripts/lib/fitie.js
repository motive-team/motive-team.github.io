...
}, /MSIE|Trident/.test(navigator.userAgent) && this.fitie.init(), this.fitie = function(t) {
    function e() {
        c.call(t, g + m, e);var a = {
            ...
            a[t] = l[t]
        }), d.border = d.margin = d.padding = 0, d.display = "block", d.height = d.width = "auto", d.opacity = 1;var h = t.videoWidth || t.width,
            s = t.videoHeight || t.height,
            u = h / s,
            v = document.createElement("object-fit");v.appendChild(t.parentNode.replaceChild(v, t));
